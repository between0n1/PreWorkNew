...
extension ViewController_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
        ...
        /*@START_MENU_TOKEN@*/AnyView(__designTimeSelection(Text(__designTimeString("#6102.[3].[0].property.[0].[0].arg[0].value", fallback: "Hello, World!")), "#6102.[3].[0].property.[0].[0]"))/*@END_MENU_TOKEN@*/
    #sourceLocation()
    }
}
