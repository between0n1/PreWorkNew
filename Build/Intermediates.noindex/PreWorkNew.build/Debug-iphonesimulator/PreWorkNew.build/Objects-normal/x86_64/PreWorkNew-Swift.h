...
#ifndef PREWORKNEW_SWIFT_H
#define PREWORKNEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PreWorkNew",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10PreWorkNew11AppDelegate")
...
SWIFT_CLASS("_TtC10PreWorkNew13SceneDelegate")
...
SWIFT_CLASS("_TtC10PreWorkNew14ViewController")
...
- (void)viewDidLoad;
- (IBAction)calculateTipWithSender:(id _Nonnull)sender;
